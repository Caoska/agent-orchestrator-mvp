  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        config: {
          name: 'Format report',
          script: `const btc = node_0.data.data.amount;
const eth = node_1.data.data.amount;
const stock = node_2.data.chart.result[0].meta.regularMarketPrice;
    ...
    steps: [
      ...
      },
      {
        ...
        config: {
          ...
          condition: 'node_0.status >= 200 && node_0.status < 300'
        },
        connections: [
