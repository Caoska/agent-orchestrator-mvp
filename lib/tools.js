...
export async function executeTransformTool(config, context) {
  ...
  for (const op of operations) {
    ...
    if (op.type === "template") {
      ...
      console.log('Template operation debug:', {
        template: op.template,
        context: Object.keys(context),
        result: Object.keys(result),
        templateContext: Object.keys(templateContext),
        btc_price: templateContext.btc_price,
        eth_price: templateContext.eth_price,
        stock_price: templateContext.stock_price
      });
      result[op.key] = renderTemplate(op.template, templateContext);
      console.log('Template result:', result[op.key]);
    }
  }
