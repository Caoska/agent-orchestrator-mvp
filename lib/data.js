...
export async function createWorkspace(workspace) {
  if (db) {
    await db.query(
      'INSERT INTO workspaces (workspace_id, name, owner_email, api_key, plan, runs_this_month, created_at) VALUES ($1, $2, $3, $4, $5, $6, $7)',
      [workspace.workspace_id, workspace.name, workspace.owner_email, workspace.api_key, workspace.plan || 'free', workspace.runs_this_month || 0, workspace.created_at]
    );
  } else {
